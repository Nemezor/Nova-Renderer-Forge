...
import com.continuum.nova.utils.AtlasGenerator.ImageName;
...
public class NovaRenderer implements IResourceManagerReloadListener {
    ...
    public static final Logger LOG = LogManager.getLogger(NovaRenderer.class);
    public static final ResourceLocation WHITE_TEXTURE_GUI_LOCATION = new ResourceLocation("white_gui");

    private boolean firstLoad = true;

    private static final List<ResourceLocation> GUI_ALBEDO_TEXTURES_LOCATIONS = new ArrayList<ResourceLocation>();
    private TextureMap guiAtlas = new TextureMap("textures");
    private Map<ResourceLocation, TextureAtlasSprite> guiSpriteLocations = new HashMap<ResourceLocation, TextureAtlasSprite>();

    private static final List<ResourceLocation> TERRAIN_ALBEDO_TEXTURES_LOCATIONS = new ArrayList<ResourceLocation>();
    private TextureMap blockAtlas = new TextureMap("textures");
    private Map<ResourceLocation, TextureAtlasSprite> blockSpriteLocations = new HashMap<ResourceLocation, TextureAtlasSprite>();

    private static final List<ResourceLocation> FONT_ALBEDO_TEXTURES_LOCATIONS = new ArrayList<ResourceLocation>();
    private TextureMap fontAtlas = new TextureMap("textures");
    private Map<ResourceLocation, TextureAtlasSprite> fontSpriteLocations = new HashMap<ResourceLocation, TextureAtlasSprite>();

    private static final List<ResourceLocation> FREE_TEXTURES = new ArrayList<ResourceLocation>();
    ...
    private void addGuiAtlas(@Nonnull IResourceManager resourceManager) {
        Interface.textureMap_createWhiteTexture(guiAtlas, WHITE_TEXTURE_GUI_LOCATION);
    ...
    private void addAtlas(@Nonnull IResourceManager resourceManager, TextureMap atlas, List<ResourceLocation> resoruces,
        ...
        Optional<TextureAtlasSprite> whiteImage = Interface.textureMap_getWhiteImage(atlas);
        whiteImage.ifPresent(image -> spriteLocations.put(Interface.textureAtlasSprite_getLocation(image), image));

        NovaNative.mc_atlas_texture atlasTexture = getFullImage(Interface.textureMap_getWidth(atlas), Interface.textureMap_getHeight(atlas), spriteLocations.values());
    ...
    private void addTextures(List<ResourceLocation> locations, String textureName, IResourceManager resourceManager, int maxAtlasSize) {
        ...
        List<AtlasGenerator.ImageName> images = new ArrayList<ImageName>();
